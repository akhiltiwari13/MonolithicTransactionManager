...
const BTSBaseUrl = envConfig.get("btsBaseUrl");  //what should be BTSBase URL?
...
class EthereumAdapter {
    ...
    getBalance = accountName =>
        new Promise((resolve, reject) => {
            return this._getAccountId(accountName)
                .then(res => {
                    console.log()
                })
    ...
    _getAccountBalance = accountId =>
        new Promise((resolve, reject) => {
            ...
            return postRequest(url, body)
                .then(response => {
                    console.log("ETH: _getAccountBalance")
                    resolve(true);
                })
                .catch(reject);
        });
